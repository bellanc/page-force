  ...
  module StandardObject
    ...
    class Contact
      STANDARD_FIELDS =[SFDCObjectField.new('Owner', 'con1'),
                        SFDCObjectField.new('Name', 'con2'),
                        SFDCObjectField.new('FirstName', 'name_firstcon2'),
                        SFDCObjectField.new('LastName', 'name_lastcon2'),
                        SFDCObjectField.new('Account', 'con4'),
                        SFDCObjectField.new('Title', 'con5'),
                        SFDCObjectField.new('Department', 'con6'),
                        SFDCObjectField.new('Birthdate', 'con7'),
                        SFDCObjectField.new('ReportsTo', 'con8'),
                        SFDCObjectField.new('Phone', 'con10'),
                        SFDCObjectField.new('HomePhone', 'con13'),
                        ...
                        SFDCObjectField.new('MailingStreet', 'con19street'),
                        SFDCObjectField.new('MailingCity', 'con19city'),
                        SFDCObjectField.new('MailingState/Province', 'con19state'),
                        SFDCObjectField.new('MailingZip/Postal Code', 'con19zip'),
                        SFDCObjectField.new('MailingCountry', 'con19country'),
                        SFDCObjectField.new('OtherStreet', 'con18street'),
                        SFDCObjectField.new('OtherCity', 'con18city'),
                        SFDCObjectField.new('OtherState/Province', 'con18state'),
                        SFDCObjectField.new('OtherZip/Postal Code', 'con18zip'),
                        SFDCObjectField.new('OtherCountry', 'con18country'),
